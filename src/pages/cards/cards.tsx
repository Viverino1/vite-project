...
export default function Cards(){
    ...
    return(
        <div className="relative w-full h-screen p-4 overflow-scroll">
            <div className="z-30 fixed left-25 right-4 top-4 h-16 rounded-lg bg-primary shadow-primary shadow-lg hover:shadow-2xl hover:shadow-primary transition-all duration-300"></div>
